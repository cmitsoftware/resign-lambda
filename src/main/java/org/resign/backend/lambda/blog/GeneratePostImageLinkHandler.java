...
public class GeneratePostImageLinkHandler implements RequestHandler<ApiGatewayRequest, ApiGatewayProxyResponse> {
...
//		String bucketName = "resign-test-resource-images";
		...
		try {
			...
			context.getLogger().log("Valid for: " + linkValiditySeconds);
